        ...
        <header className="pt-4 pb-4 header">
            <div className={[headerStyles.menuContainer, headerStyles.menu].join(' ')}>
                <div className="linksBar">
                    <NavLink to="/" className={({ isActive })=>isActive ? `${headerStyles.menuLink} ${headerStyles.menuLink_active} ` : headerStyles.menuLink}><BurgerIcon />
                        <span className='text text_type_main-default'>Конструктор</span>
                    </NavLink>
                    <NavLink to="/orders" className={({ isActive })=>isActive ? `${headerStyles.menuLink} ${headerStyles.menuLink_active} ` : headerStyles.menuLink}><ListIcon />
                ...
                <NavLink to="/profile" className={({ isActive })=>isActive
                    ...
                    <ProfileIcon /><span className='text text_type_main-default'>
